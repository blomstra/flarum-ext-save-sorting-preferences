...
flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('blomstra/save-sorting-preferences', function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/common/components/Dropdown */ "flarum/common/components/Dropdown");
/* harmony import */ var flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_0__);
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().initializers.add('blomstra/save-sorting-preferences', function () {
  var sort = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().search.params().sort;
  if (!sort) {
    m.request({
      method: 'GET',
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_3__.override)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'viewItems', function (user) {
    var items = new (flarum_common_utils_ItemList__WEBPACK_IMPORTED_MODULE_4___default())();
    var sortMap = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().discussions.sortMap();
    var sortOptions = Object.keys(sortMap).reduce(function (acc, sortId) {
      acc[sortId] = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans("core.forum.index_sort." + sortId + "_button");
      return acc;
    }, {});
    items.add('sort', m((flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_0___default()), {
      buttonClassName: "Button",
      label: sortOptions[sort] || Object.keys(sortMap).map(function (key) {
        return sortOptions[key];
      })[0],
      accessibleToggleLabel: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('core.forum.index_sort.toggle_dropdown_accessible_label')
      ...
      return m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5___default()), {
        ...
        onclick: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().search.changeSort.bind((flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().search), value),
        active: active
      }, label);
    })));
    return items;
